<template>
  <div class="wrap">
        ...
        <li v-for="(item,index) in list" :key="index">
          ...
          <div>
            ...
            <div class="d_right f_r">
              <button
                v-if="item.uid != $store.state.user_info.id"
                class="btn"
                @click="bsBtn(item.id,item.residue)"
              >{{btnType}}</button>
          ...
          <div class="d_con">
            <div class="d_form">
              ...
              <div v-if="sell_info.wechat_img">
                ...
                <span class="right">
                  <img :src="sell_info.wechat_img" alt @click="showBig(sell_info.wechat_img)">
                </span>
              </div>
              <div>
            ...
            <div class="d_btns">
              <button class="btn" @click="toUpload">确认下单</button>
            </div>
          </div>
        </div>
      </div>
    </x-dialog>
    <x-dialog v-model="dialog1" class="de_dialog up_dialog">
      <div class="dialog">
        <div class="ta_r close_div">
            ...
            <div class="upload_div">
              ...
              <div class="pay_ways">
                ...
                <div @click="selectWay(3)">
                  <span
                    class="iconfont icon-yuanxingweixuanzhong"
                    :class="{'icon-danxuanxuanzhong':way == 3}"
                  ></span>银行卡
                </div>
              </div>
              <div class="up_div">
    ...
    <div v-if="bigIf" class="big_div" @click="bigIf = false">
