<template>
    <div class="wrap">
        ...
        <div class="main">
            <div>
                <tab class="tab tab_radius" :line-width = 2 custom-bar-width="50%" bar-active-color="#ba9870" active-color="#ba9870" :scroll-threshold="5">
            ...
            <div v-if="list.length==0" style="color:rgba(255,255,255,.5);text-align:center;margin-top:16px;">暂无挂单...</div>
            <div class="d_list" v-if="type!=3&&list.length!=0">
                <ul v-for="(item,index) in list" :key="index">
                    ...
                    <li class="li">
                        <span>类型</span>
                        <span :class="item.status==1?'f_c_red':'f_c_blue'">{{item.status==1?'买入':'卖出'}}</span>
                    </li>
                    <li class="li">
                        <span>数量</span>
                    ...
                    <li class="li">
                        ...
                        <span v-if="type==1&&item.status==1&&item.path==null">未付款</span>
                        <span v-if="type==1&&item.status==1&&item.path!=null">已付款</span>
                        <span v-if="type==1&&item.status==2&&item.path==null">买家未付款</span>
                        <span v-if="type==1&&item.status==2&&item.path!=null">买家已付款</span>
                    ...
                    <li v-if="type!=0" class="li li_img">
                        <span>支付截图</span>
                        <div>
                            <img @click="bigimg(item.path)" src="" alt="">
                        </div>
                    </li>
                    <li class="li_btns" v-if="type==0">
                        <button class="btn" @click="cancelDeal(item.id)">放弃挂单</button>
                    </li>
                    <li class="li_btns" v-if="type==1&&item.status==1&&item.path==null">
                        <button class="btn" @click="pay(item.hid)">去支付</button>
                    </li>
                    <li class="li_btns" v-if="type==1&&item.status==2&&item.path!=null">
                        <button v-if="item.reciprocal_time!='00:00:00'" class="btn" @click="finish(item.id)">确认收款</button>
                    </li>
                    <li class="li_btns li_btns_" v-if="type==1&&item.status==2&&item.path==null">
                        <button class="btn" @click="inform(item.tid)">提醒买家付款</button>
                        <button class="btn" @click="cancelDeal(item.id)">取消订单</button>
                    </li>
                    <li class="li_btns li_btns_" v-if="type==1&&item.status==1&&item.path!=null">
                        <button class="btn" @click="inform(item.tid)">提醒卖家确认</button>
                        <button v-if="item.reciprocal_time=='00:00:00'" class="btn" @click="toComplain(item.id)">申请投诉</button>
                    </li>
                </ul>
            </div>
            <div class="d_list" v-if="type==3&&list.length!=0">
                        ...
                        <div class="upload_div">
                            ...
                            <div class="pay_ways">
                                <div @click="selectWay(0)">
                                    <span class="iconfont icon-yuanxingweixuanzhong" :class="{'icon-danxuanxuanzhong':way == 0}"></span>支付宝
                                </div>
                                <div @click="selectWay(1)">
                                    <span class="iconfont icon-yuanxingweixuanzhong" :class="{'icon-danxuanxuanzhong':way == 1}"></span>微信
                                </div>
                                <div @click="selectWay(2)">
                                    <span class="iconfont icon-yuanxingweixuanzhong" :class="{'icon-danxuanxuanzhong':way == 2}"></span>银行卡
                                </div>
                            </div>
                            <div class="up_div">
